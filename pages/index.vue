  ...
  <main class="bg-[#fbf3f4]">
    <div class="mx-auto max-w-6xl bg-white pt-24">
      <div class="">
        ...
        <div class="flex justify-center pt-6 bg-white">
          <el-button class="!bg-[#001EFF]"  @click="drawerShare = true" size="large" style="background-color: #001EFF !important">
          <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="16" height="16" viewBox="0,0,256,256">
<g fill="#FFF9F5" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal"><g transform="scale(9.84615,9.84615)"><path d="M21,0c-2.76172,0 -5,2.23828 -5,5c0,0.08594 0.02734,0.16406 0.03125,0.25l-7.84375,3.9375c-0.86719,-0.73047 -1.96484,-1.1875 -3.1875,-1.1875c-2.76172,0 -5,2.23828 -5,5c0,2.76172 2.23828,5 5,5c1.22266,0 2.32031,-0.45703 3.1875,-1.1875l7.84375,3.9375c-0.00391,0.08594 -0.03125,0.16406 -0.03125,0.25c0,2.76172 2.23828,5 5,5c2.76172,0 5,-2.23828 5,-5c0,-2.76172 -2.23828,-5 -5,-5c-1.22266,0 -2.32031,0.45703 -3.1875,1.1875l-7.84375,-3.9375c0.00391,-0.08594 0.03125,-0.16406 0.03125,-0.25c0,-0.08594 -0.02734,-0.16406 -0.03125,-0.25l7.84375,-3.9375c0.86719,0.73047 1.96484,1.1875 3.1875,1.1875c2.76172,0 5,-2.23828 5,-5c0,-2.76172 -2.23828,-5 -5,-5z"></path></g></g>
</svg> &nbsp;
           <p class="font-semibold " style="color: #FFF9F5 !important">Chia sẻ</p>
        </el-button>
        </div>
      </div>
    ...
    <template #default>
      <div>
        ...
        <div class="md:flex md:justify-start grid grid-cols-7 gap-2">
          ...
          <img width="40" height="40" @click="onShareSocial('pinterest')" src="@/assets/social/pinterest.png" alt="" />
          <img width="40" height="40" @click="onShareSocial('linkedin')" src="@/assets/social/linkedin.png" alt="" />
          <img width="40" height="40" @click="onShareSocial('buffer')" src="@/assets/social/buffer.png" alt="" />
          <img width="40" height="40" @click="onShareSocial('diggit')" src="@/assets/social/diggit.png" alt="" />
          <img width="40" height="40" @click="onShareSocial('email')" src="@/assets/social/email.png" alt="" />
          <img width="40" height="40" @click="onShareSocial('print')" src="@/assets/social/print.png" alt="" />
          <img width="40" height="40" @click="onShareSocial('reddit')" src="@/assets/social/reddit.png" alt="" />
          <img width="40" height="40" @click="onShareSocial('stumbleupon')" src="@/assets/social/stumbleupon.png" alt="" />
          <img width="40" height="40" @click="onShareSocial('tumblr')" src="@/assets/social/tumblr.png" alt="" />
          <img width="40" height="40" @click="onShareSocial('vk')" src="@/assets/social/vk.png" alt="" />
          <img width="40" height="40" @click="onShareSocial('yummly')" src="@/assets/social/yummly.png" alt="" />
        </div>
      </div>
    </template>
  </el-drawer>
